...
$statementu="SELECT * FROM `mytable` WHERE `ürün_no` = $x1";
if ($result=mysqli_query($connection,$statementu)) {
    while($row=mysqli_fetch_assoc($result))
    {   
        array_push($foto_list,$row['image']);
    }
} else {
...
<html lang="en">
  <head>
    ...
    <title>Estate sale - Real Estate Category Bootstrap Responsive Website Template - Property single : W3layouts</title>
          ...
          <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
              <ul class="navbar-nav ml-lg-5 mr-auto">
                  <li class="nav-item @@home__active">
                      <a class="nav-link" href="bobb2.html">Home <span class="sr-only">(current)</span></a>
                  </li>
                  ...
                  <li class="nav-item dropdown active">
                      ...
                      <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                          <a class="dropdown-item active" href="property-single.html">Single property</a>
                      </div>
                  </li>
...
<section class="w3l-blog post-content py-5">
    <div class="container py-lg-4 py-md-3 py-2">
        ...
        <div class="post-content">
            <h2 class="title-single"> En Kaliteli Adam</h2>
        </div>
        <div class="blo-singl mb-4">
            <ul class="blog-single-author-date align-items-center">
                <li>
                    <p>Girne, Yukarı Girne, Hacıali Sitesi</p>
                </li>
                <li><span class="fa fa-bed"></span> 3 Yatak Odası</li>
                <li><span class="fa fa-bath"></span> 2 Tuvalet & Banyo</li>
                <li><span class="fa fa-share-square-o"></span> 135m²</li>
            </ul>
            <ul class="share-post">
                <a href="#url" class="cost-estate m-o">₺45,600</a>
            </ul>
        </div>
        <div class="row">
                ...
                <div class="blog-single-post">
                    <div class="single-post-image mb-5">
                        <div class="owl-blog owl-carousel owl-theme">
                            <div class="item">
                                <div class="card"><?php 
                                echo "<img src='images/".$foto_list[0]."' >";
        ?>
                                </div>
                            </div>
                            <div class="item">
                                <div class="card">
                                   <?php 
                                echo "<img src='images/".$foto_list[1]."' >";
        ?>
                                </div>
                            </div>
                            <div class="item">
                    ...
                    <div class="single-post-content">
                        <h3 class="post-content-title mb-3">Açıklamalar</h3>
                        <p class="mb-4">
                        ...
                        <div class="single-bg-white">
                            ...
                            <ul class="details-list">
                                <li><strong>İlan Numarası :</strong> <?php echo "$x4"?> </li>
                                <li><strong>İlan Büyüklüğü :</strong> <?php echo "$x4"?> </li>
                                <li><strong>Odalar :</strong> 2 </li>
                                <li><strong>Yatak Odaları :</strong> 5 </li>
                                <li><strong>Tuvalet & Banyolar :</strong> 2 </li>
                                <li><strong>Garaj :</strong> 1 </li>
                                <li><strong>İlan Ücreti :</strong>  ₺987 </li>
                            </ul>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="single-bg-white">
                        ...
                        <div class="agent-map">
                         <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3260.0621144507454!2d33.369687626210045!3d35.204921739369595!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14de16dec0e9c84f%3A0x89cfa3b43c97764d!2sAtakom!5e0!3m2!1sen!2s!4v1607813114455!5m2!1sen!2s" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                        </div>
                    </div>
                ...
                <aside class="sidebar">
                    ...
                    <div class="sidebar-widget popular-posts">
                        <div class="sidebar-title">
                            <h4>Emlakçı ile İrtibata Geçin</h4>
                        </div>

                        <article class="post">
                            <figure class="post-thumb"><img src="assets/images/l5.jpg" class="radius-image" alt="">
                            </figure>
                            <div class="text mb-0"><a href="#blog-single">Ali Yılmaz
                                </a>
                                <div class="post-info">+90 (542) 886 2927</div>
                                <div class="post-info">companyrealty@mail.com</div>
                            </div>
                        </article>
                        <button type="submit" class="btn btn-primary btn-style w-100">Detayları Görüntüle</button>
                    </div>
                    ...
                    <div class="sidebar-widget popular-posts">
                        ...
                        <article class="post">
                            ...
                            <div class="text"><a href="#blog-single">Neden bu işin en iyisiyiz?
                                </a>
                                <div class="post-info">13 Aralık 2020</div>
                            </div>
                        </article>
                        ...
                        <article class="post">
                            ...
                            <div class="text"><a href="#blog-single">Kendi binanı inşa edecek yeri Satın Al!
                                </a>
                                <div class="post-info">14 Aralık 2020</div>
                            </div>
                        </article>
      ...
      <div class="footers20-content">
        <div class="d-grid grid-col-4 grids-content">
          <div class="column">
            ...
            <a href="#url" class="title-small">Bilgi almak için</a>
            <h4>Facebook üzerinden anlık olarak detaylı bilgi alabilirsiniz.</h4>
            <a href="#buytheme" class="btn btn-style btn-primary"> Facebook'a Bak
              <span class="fa fa-long-arrow-right ml-2"></span> </a>
          </div>
          <div class="column">
            <a href="#url" class="link"><span class="fa fa-phone"></span></a>
            <a href="#url" class="title-small">Detaylı bilgi için</a>
            <h4>İlan hakkında sormak istediğiniz ne varsa arayabilirsiniz. </h4>
          ...
          <div class="column mt-lg-0 mt-md-5">
            <h4 class="mb-1">Yeni ilanlardan haberdar olmak için Kayıt olun.</h4>
            <p>Yeni İlanlara Hızlıca Erişin!</p>
            <form action="#" class="subscribe-form mt-4" method="post">
              <div class="form-group">
                <input type="email" name="subscribe" placeholder="E-mail Adresinizi Girin" required="">
                <button class="btn btn-style btn-primary">Kaydol</button>
              </div>
            </form>
            <ul class="footers-17_social">
              <h4 class="d-inline mr-4">Takip Edin:</h4>
        ...
        <div class="d-grid grid-col-3 grids-content1 bottom-border">
          <div class="columns copyright-grid align-self">
            <p class="copy-footer-29">© 2020 Boran Emlak. All rights reserved | Designed by <a
                href="https://www.instagram.com/toprakdikici18/">Toprak Tarkan Dikici, <a href="https://www.instagram.com/okachuchan/">Okay Olcay</a></p>
